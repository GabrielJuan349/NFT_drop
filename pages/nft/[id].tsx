        ...
        <div className="flex h-screen flex-col lg:grid lg:grid-cols-10"> 
            ...
            <div className="bg-gradient-to-br from-cyan-800 to-rose-500 lg: col-span-4">
                ...
                py-2 lg:min-h-screen">
                    ...
                    from-yellow-400 to-purple-600 p-2">
                        <img className="w-44 rounded-xl object-cover lg:h-96
                        lg:w-72" src="https://links.papareact.com/8sg" alt="" />
                    </div>
            ...
            <div className="flex flex-1 flex-col p-12 lg:col-span-6">
                ...
                <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0">
                    ...
                    <h1 className="text-3xl font-bold lg:font-extrabold">The PAPAFAM Ape Coding Club | NFT Drop</h1>
                </div>
